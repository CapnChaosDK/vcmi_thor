...
- Status: `hardware validated` through Slice 23; Slice 24 awaits candidate CI and hardware validation.
...
- Status: `in progress`; local diff/static checks and focused Java compilation passed, while native and Android JVM suites require the documented Linux CI toolchain. CI and AYN Thor hardware validation have not run.
