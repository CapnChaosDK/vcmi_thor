...
- Phase: Slices 1 through 25 are promoted. Slice 25 is CI- and hardware-validated on candidate `fb8e362e09c7aadeeeae19514f71050919920f69`; PR #11 merged into the product branch as `b5b9f664e` on 2026-09-26. The current implementation branch contains the CI-passed Slice 26 candidate and receipt documentation.
- Status: `hardware validated` through Slice 25 on the exact candidate. Slice 26 passed candidate CI and is `awaiting hardware validation`.
- Current work: Slice 26 completes Hero Meeting artifact interaction with exact visible-row drag/drop and whole-inventory move/swap. Slice 25's corrected candidate `fb8e362e09c7aadeeeae19514f71050919920f69` passed Thor CI [`36235097042`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235097042), including focused native/Android tests and ARM64 packaging. Artifact `thor-candidate-arm64-36235097042` contains package `is.xyz.vcmi.thor`; APK SHA-256 `8352b6a966915aaf6360c4077f7e86b411caa291378853848a9b4629624a742b`. On 2026-09-26 the user confirmed the full hardware checklist for this exact APK after install and launch. PR #11 preflight [`36237670399`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36237670399) passed on a prior documentation-only receipt head; PR #11 subsequently merged.
...
- Select the next coherent user-facing capability from current code and the maintained roadmap after Slice 26 candidate CI and device evidence. Do not infer device success from source review or CI.
