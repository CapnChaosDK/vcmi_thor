...
- Status: `hardware validated` through Slice 23; Slice 24 passed CI and the APK was installed/launched on AYN Thor, with full behavior hardware validation pending.
