...
- Current work: Slice 28 adds player-installed hero portraits to the Adventure, Hero Window, and Hero Meeting decks. Implementation PR #15 is open. First candidate `dcf130cbcf05884d9fd551e7e97c8765c93fe13e` failed Thor CI during native compilation; the fix is published in candidate `64ad69405653fc03e58362996d9a302610d1c4fe`, now awaiting run [`36266999948`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36266999948). Device validation is pending. Slice 27's implementation, CI/device receipt, and Slice 26/25 validation history are recorded below.
...
- Status: `awaiting CI` on product baseline `9645eeac4f90c1d9e021fdc4854822478a2ad492`. Implementation PR [#15](https://github.com/CapnChaosDK/vcmi_thor/pull/15) is open. First candidate `dcf130cbcf05884d9fd551e7e97c8765c93fe13e` failed Thor CI run [36266461474](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36266461474) during compilation because the shared publisher used the wrong SDL3 renderer include root and omitted `GameEngine.h` for `ENGINE`. The corrected exact candidate `64ad69405653fc03e58362996d9a302610d1c4fe` is running Thor CI push run [36266999948](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36266999948) from `ci/thor-candidate-validation`. Hardware validation awaits that candidate's CI-built APK and checksum.
