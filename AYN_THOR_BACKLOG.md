...
- Phase: Slices 1 through 23 are promoted. Slices 20 and 21 were CI-built and hardware-validated on candidate `24a061c915977684299250ccd20b7668ab041901`; Slice 22 on `bff5550956b1297b66f132d94ac8d495342a5623`; and Slice 23 on `6db4f294b24504dc5e3d8c0dffa5daabcc52fdf3`. Slice 24 is in progress.
- Status: `hardware validated` through Slice 23; corrected Slice 24 candidate CI run `36226537550` is in progress and hardware validation remains pending.
...
- Status: `in progress`. First implementation candidate `05fc58cec0bc3c77e41eed0aaffd4fda2cbed9f3` was published to `ci/thor-candidate-validation`; Thor CI run [`36181337298`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36181337298) failed at focused native compilation because of a missing closing parenthesis in artifact snapshot normalization, so ARM64 did not run. Corrected candidate `6591870eba4928992435aaa5ce8f277e077bc7e4` started Thor CI run [`36226537550`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36226537550), which is in progress. Local diff/static checks and focused Java compilation passed. Android JVM suites, ARM64 packaging, and AYN Thor hardware validation remain pending.
