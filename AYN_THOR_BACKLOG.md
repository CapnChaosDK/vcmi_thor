...
- Current work: Slice 28 adds player-installed hero portraits to the Adventure, Hero Window, and Hero Meeting decks. Implementation PR #15 is open. Candidate `c57b687883823cba2e6739b645fab59f0b9ff05f` failed Thor CI run [`36267440750`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36267440750) during native compilation because the new publisher used `CAnimation` through a forward declaration. Replacement candidate `74294f8af87256d1170f1fdcedc3dfbf0d731dfa` is running Thor CI push run [`36268252948`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36268252948): preflight passed and the ARM64 candidate job is in progress. PR preflight does not validate or package the APK. Device validation is pending. Slice 27's implementation, CI/device receipt, and Slice 26/25 validation history are recorded below.
