...
- Current work: Slice 25 adds Hero Meeting multi-slot army redistribution. Corrected candidate `fb8e362e09c7aadeeeae19514f71050919920f69` passed Thor CI [`36235097042`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235097042), including focused native/Android tests and ARM64 packaging. Artifact `thor-candidate-arm64-36235097042` contains package `is.xyz.vcmi.thor`; APK SHA-256 `8352b6a966915aaf6360c4077f7e86b411caa291378853848a9b4629624a742b`. PR #11 preflight [`36235207019`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235207019) passed. The verified APK was installed and launched on AYN Thor; the full behavior checklist remains pending.
...
- Status: `awaiting hardware validation`. Corrected candidate `fb8e362e09c7aadeeeae19514f71050919920f69` passed Thor CI run [`36235097042`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235097042), including focused native Thor tests, focused Android Thor tests, ARM64 APK build, checksum verification, and package verification. Artifact [`thor-candidate-arm64-36235097042`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235097042/artifacts/10903928065) has upload digest `b5d1d62ccfada3be30fa057cebcb0d14f452da46e4a5e1d679e0e6a1048fe28b`; package `is.xyz.vcmi.thor`; ABI `arm64-v8a`; APK SHA-256 `8352b6a966915aaf6360c4077f7e86b411caa291378853848a9b4629624a742b`. The restored ccache recorded 658/842 hits (78.15%). PR #11 preflight [`36235207019`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235207019) also passed. On 2026-09-26 the checksum-verified APK was installed on an AYN Thor and `is.xyz.vcmi.thor` launched with `VcmiSDLActivity` in the foreground. This confirms installation and launch only; the full gameplay/lifecycle/input checklist remains pending. The earlier candidate `9f2abebe94ab1e037cd927385eacf7cd191a8221` failed run [`36233203449`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36233203449) at `ThorContextIdsTest.adventureActionIdsUseStableExplicitMasks` because Java's `maskFor` bound stopped at action 21; candidate `fb8e362e` contains the fix.
