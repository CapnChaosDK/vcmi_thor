...
- Current work: Slice 28 adds player-installed hero portraits to the Adventure, Hero Window, and Hero Meeting decks. Implementation PR #15 is open. Candidate `64ad69405653fc03e58362996d9a302610d1c4fe` failed Thor CI run [`36266999948`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36266999948) because `IRenderHandler` was still incomplete; the current fix includes its interface header. Device validation is pending. Slice 27's implementation, CI/device receipt, and Slice 26/25 validation history are recorded below.
