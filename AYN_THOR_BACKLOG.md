...
- Phase: Slices 1 through 24 are promoted. Slice 25 is CI- and hardware-validated on candidate `fb8e362e09c7aadeeeae19514f71050919920f69`; the local implementation branch has that exact product/build tree, and PR #11 remains open for the remote product branch.
- Status: `hardware validated` through Slice 25 on the exact candidate. The Slice 25 remote product-branch PR is open; no remote merge is recorded.
- Current work: Slice 25 adds Hero Meeting multi-slot army redistribution. Corrected candidate `fb8e362e09c7aadeeeae19514f71050919920f69` passed Thor CI [`36235097042`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235097042), including focused native/Android tests and ARM64 packaging. Artifact `thor-candidate-arm64-36235097042` contains package `is.xyz.vcmi.thor`; APK SHA-256 `8352b6a966915aaf6360c4077f7e86b411caa291378853848a9b4629624a742b`. On 2026-09-26 the user confirmed the full hardware checklist for this exact APK after install and launch. PR #11 remains open; its preflight [`36237670399`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36237670399) passed on a prior documentation-only receipt head.
