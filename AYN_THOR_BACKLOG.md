...
- Status: `awaiting CI`; focused source/Java checks passed locally, while the authoritative Thor candidate CI and physical AYN Thor validation are pending. Slice 25's candidate and hardware receipts above remain historical.
