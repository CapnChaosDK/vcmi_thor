...
- Current work: Slice 28 adds player-installed hero portraits to the Adventure, Hero Window, and Hero Meeting decks. Implementation PR #15 is open. Its first candidate `dcf130cbcf05884d9fd551e7e97c8765c93fe13e` failed Thor CI run [`36266461474`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36266461474) during native compilation; the renderer include paths and missing `GameEngine.h` include are corrected in the current work. Device validation is pending. Slice 27's implementation, CI/device receipt, and Slice 26/25 validation history are recorded below.
