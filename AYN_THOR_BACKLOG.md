...
- Status: `awaiting hardware validation` of corrected candidate `27808ba975555879ee72d6435ad5c3891137275a`. Thor CI run `35610995986` passed native tests, ARM64 build, Android tests, package verification, receipt, and artifact upload. The corrected artifact ZIP SHA-256 is `890dc871fd65ce731b7cc387dfe787100bc4a3b26e833f3fc9f22a3dccf0ca6f`; APK SHA-256 is `179984305e8d625a0d3fb82fa513c520c8e2bbb90d216cda466b5148e2c9ab46`. The checksums and receipt were verified locally; the corrected APK was installed and launched on an AYN Thor, but its layout and behavior have not yet been checked manually. Earlier candidate `d8cc679d1013ed2f8822626a73fcee6a3ee5c0b3` passed run `35603630947` and was installed on an AYN Thor. The user reported all functional checklist items passed, but its tabs/buttons overlapped the hero summary and the panel felt cramped. A focused layout/regression recheck is still required before Slice 18 can be marked hardware validated.
