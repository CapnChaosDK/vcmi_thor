...
- Current work: Slice 25 adds Hero Meeting multi-slot army redistribution. Corrected candidate `fb8e362e09c7aadeeeae19514f71050919920f69` is running Thor CI [`36235097042`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235097042); PR #11 preflight [`36235122525`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235122525) is also running. Device validation is pending.
...
- Status: `awaiting CI`. Corrected candidate `fb8e362e09c7aadeeeae19514f71050919920f69` is running Thor CI [`36235097042`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235097042); PR #11 preflight run [`36235122525`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36235122525) is in progress. The earlier candidate `9f2abebe94ab1e037cd927385eacf7cd191a8221` failed run [`36233203449`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36233203449) at `ThorContextIdsTest.adventureActionIdsUseStableExplicitMasks` because Java's `maskFor` bound stopped at action 21. The fix now includes action 22. No corrected APK or device result exists yet.
