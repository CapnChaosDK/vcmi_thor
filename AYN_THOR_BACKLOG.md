...
- Status: `hardware validated` through Slice 23; Slice 24 candidate CI run `36181337298` is in progress and hardware validation remains pending.
...
- Status: `in progress`. Implementation candidate `05fc58cec0bc3c77e41eed0aaffd4fda2cbed9f3` was published to `ci/thor-candidate-validation`; Thor CI run [`36181337298`](https://github.com/CapnChaosDK/vcmi_thor/actions/runs/36181337298) is in progress. Local diff/static checks and focused Java compilation passed. Native and Android JVM suites and ARM64 packaging await CI; AYN Thor hardware validation has not run.
