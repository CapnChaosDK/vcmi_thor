...
- Status: `hardware validated` through Slice 23; Slice 24's first candidate preflight failed on a native syntax error, a correction is pending CI, and hardware validation remains pending.
